...
#the following fn returns a dictionary that contains the rules. The dictionary's keys behave as extensions of the files and values act as moved paths
...
#the following fn takes a list of files and moves the files to their resp files
...
#the following fn is used when a simple mode is selected
...
#the following fn is used when recursive mode is selected    
